...
module.exports = {
    ...
    run: async (client, message, args) => {
		var tokensArray = ['0x31471e0791fcdbe82fbf4c44943255e923f1b794', '0xf1018c71eebe32dd85012ad413bab6b940d0d51e', '0x00e1656e45f18ec6747f5a8496fd39b50b38396d'];
        tokensArray.forEach(x => {
			var tokenData = GetTokenData(message, x);
			console.log(tokenData);
			//message.channel.send(`Updated_at: ${tokenData.updated_at}; Name: ${tokenData.name}; Symbol: ${tokenData.symbol}; Price_USD: ${tokenData.price}; Price_BNB: ${tokenData.price_BNB}`);
		})
    }
}
