...
client.on('ready', () => {
	...
	client.guilds.get("223393200105062410").client.channels.fetch("734782891405475850").then(channel => channel.messages.fetch("737753727171297397").then(message => message.react("👍");
